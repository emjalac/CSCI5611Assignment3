...
void World::initScene(int num)
{
	...
	switch(num)
	{
		...
		case 5:
			...
			break;
		// case 6:
		// 	printf("Initializing scene #6 (22x50)\n");
		// 	starts[0] = new Node(Vec3D(10,0,-24));
		// 	starts[1] = new Node(Vec3D(6,0,-24));
		// 	starts[2] = new Node(Vec3D(2,0,-24));
		// 	starts[3] = new Node(Vec3D(-2,0,-24));
		// 	starts[4] = new Node(Vec3D(-6,0,-24));
		// 	starts[5] = new Node(Vec3D(-10,0,-24));
		// 	goals[0] = new Node(Vec3D(10,0,24));
		// 	goals[1] = new Node(Vec3D(6,0,24));
		// 	goals[2] = new Node(Vec3D(2,0,24));
		// 	goals[3] = new Node(Vec3D(-2,0,24));
		// 	goals[4] = new Node(Vec3D(-6,0,24));
		// 	goals[5] = new Node(Vec3D(-10,0,24));
		// 	num_characters = 6;
		// 	initCharacters();
		// 	ob = new WorldObject(Vec3D(9.5,0,-10));
		// 	ob->setSize(Vec3D(3,3,3)); 
		// 	ob->setColor(Vec3D(.2,.2,.2));
		// 	ob->setVertexInfo(SPHERE_START, SPHERE_VERTS);
		// 	obstacles[cur_num_obstacles] = ob;
		// 	cur_num_obstacles++;
		// 	ob = new WorldObject(Vec3D(6.5,0,-10));
		// 	ob->setSize(Vec3D(3,3,3)); 
		// 	ob->setColor(Vec3D(.2,.2,.2));
		// 	ob->setVertexInfo(SPHERE_START, SPHERE_VERTS);
		// 	obstacles[cur_num_obstacles] = ob;
		// 	cur_num_obstacles++;
		// 	ob = new WorldObject(Vec3D(-.5,0,-10));
		// 	ob->setSize(Vec3D(3,3,3)); 
		// 	ob->setColor(Vec3D(.2,.2,.2));
		// 	ob->setVertexInfo(SPHERE_START, SPHERE_VERTS);
		// 	obstacles[cur_num_obstacles] = ob;
		// 	cur_num_obstacles++;
		// 	ob = new WorldObject(Vec3D(-3.5,0,-10));
		// 	ob->setSize(Vec3D(3,3,3)); 
		// 	ob->setColor(Vec3D(.2,.2,.2));
		// 	ob->setVertexInfo(SPHERE_START, SPHERE_VERTS);
		// 	obstacles[cur_num_obstacles] = ob;
		...
		// 	obstacles[cur_num_obstacles] = ob;
		// 	cur_num_obstacles++;
		// 	max_num_milestones = 100;
		// 	for (int i = 0; i < num_characters; i++)
		// 	{
		// 		milestones[i] = new Node*[max_num_milestones];
		// 		milestones[i][0] = new Node(Vec3D(3,0,-10));
		// 		milestones[i][1] = new Node(Vec3D(3,0,-8));
		// 		milestones[i][2] = new Node(Vec3D(3,0,-12));
		// 		milestones[i][3] = new Node(Vec3D(-3,0,10));
		// 		milestones[i][4] = new Node(Vec3D(-3,0,8));
		// 		milestones[i][5] = new Node(Vec3D(-3,0,12));
		// 		cur_num_milestones[i] = 6;
		// 	}
		// 	max_neighbors = 10;
		// 	break;
	}
